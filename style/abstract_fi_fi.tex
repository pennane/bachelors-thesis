...
\begin{otherlanguage}{finnish}
  ...
  {\renewcommand{\arraystretch}{1.1}
    \begin{tabular}{@{}p{4.7cm} >{\raggedright\arraybackslash}p{10.8cm}@{}}
      ...
      \\
      Otsikko:              & \parbox[t]{10.8cm}{\otsikko}      % Use \parbox to contain the title within the second column
      \\
      ...
      \vspace{.2mm}
      \makebox[0pt][l]{\hspace{-0.2cm}\parbox{\dimexpr\textwidth-0.5cm\relax}{\tiivistelma}}
      }
      \\
      \\
