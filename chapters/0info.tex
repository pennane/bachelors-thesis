...
\def\aihe{Lyhyt kuvaus opinnäytetyöstä. Max 255 merkkiä. Funktionaalista koodia jne jne}%for the pdf metadata/properties. If not used, empty it and also the \def\subject.
...
\def\subject{Short description of the thesis. Max 255 characters. Its the funksönal programming}%for the pdf metadata/properties. If not used, empty it and also the \def\aihe.
