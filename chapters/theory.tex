...
Jos jakamisesimerkkiin saa määritettyä joukot funktion oikeiksi rajoitteiksi, ei funktiota voi käyttää väärin. Avuksi tarvitsee tuoda staattinen tyypitys \glsdisp{ts}{TypeScriptillä} \glsdisp{js}{JavaScriptiin} (Koodiesimerkki \ref{code:ts_set_theory_5}) \cite{typsecript_website}.
...
Joukko-opin yhdistäminen ohjelmointiin ei ole ajattelutapa, jota rinnastetaan ainosstaan funktionaaliseen ohjelmointiin. Puhtaat funktiot ovat kuitenkin fundamentaalisesti aina siirtymisiä joukoista joukkoihin. Siksi joukko-opin ajattelu on vähintäänkin tervetullutta (Kuva \ref{fig:function_composition_in_sets}).
