...
Monadi on monoidi endofunktorien kategoriassa \cite{bartosz_category_for_progamers_10}. Näin kuvatataan \glsdisp{monad}{monadi-rakennetta}. Jotta voi ymmärtää kuvauksen, on opiskeltava kategoriateoriaa muutaman yliopistotasoisen kurssin verran ottamatta huomioon vaadittuja ennakkotietoja, mitä tarvitaan siihen, että kategoriateoriaa voi edes alkaa opiskelemaan.
...
blaa chain ja pure, x laatikkoon, halutaan tehdä äksästä uusi, ja se laitetaan taas laatikkoon.
