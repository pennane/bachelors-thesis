...
\newglossaryentry{composed_function}{
	...
	description={\protect\engl{function composition} Useammasta funktiosta koostettu funktio, jossa funktiot suoritetaan toinen toisensa jälkeen niin, että edellisen tuloste annetaan seuraavan syötteeksi}
}