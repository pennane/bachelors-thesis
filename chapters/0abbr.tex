...
\newglossaryentry{set_theory}{
	name={Joukko-oppi},
	description={\protect\engl{set theory} Joukko-oppi on joukkojen ominaisuuksiin perehtynyt matematiikan osa-alue. Joukko-oppi on perustavanlaatuisessa merkityksessä tietorakenteissa. Joukko-opissa olennaisimpia laskutoimituksia ovat esimerksiksi unioni, leikkaus ja joukkoerotus}
}
...
\newglossaryentry{composed_function}{
	...
	description={\protect\engl{function composition} Useammasta funktiosta koostettu funktio, jossa funktiot suoritetaan toinen toisensa jälkeen niin, että edellisen tuloste anneetaan seuraavan syötteeksi}
}