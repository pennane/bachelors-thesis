...
\end{minted}
    \caption{JavaScript-esimerkki yhdistetystä funktiosta. Funktioiden yksityiskohtia ei tarvitse tietää, että voi ymmärtää kokonaiskuvan.}
...
Käsiteltäviä asioita pyritään perkaamaan \glsdisp{language_agnostic}{kieliagnostisesti}, jolloin saadut tiedot ja taidot olisivat oleellisia myös kehittäjille, jotka eivät käytä TypeScriptiä tai JavaScriptiä.
