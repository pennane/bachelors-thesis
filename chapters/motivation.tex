...
\end{minted}
    \caption{TypeScript-esimerkki yhdistefunktiosta käytännönnöllisessä projektissa. Valittu koodi on osa funktionaalisella tyylillä kirjoitettua Tetris-peliä.}
