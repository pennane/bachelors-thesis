...
Näin Result-tyyppi voi sisältää myös arvon \mintinline{typescript}|null|, sillä se Result-objektin tarkan tyypin voi päätellä ilman sitä (joko value tai error kentän läsnäolosta). Näin rakennettuna tyypille on myös helppo rakentaa apufunktioita, joilla selvitetään, onko paluuarvo onnistunut, vai ei. Voi myös luoda apufunktiot, joilla luoda Result-objekteja. (Koodiesimerkki \ref{code:result_helpers}).
