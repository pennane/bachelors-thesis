...
Pääasia on, että tyyppi kuvaa listaa, joka ei voi olla tyhjä. Tyypillä on kenttä \mintinline{javascript}|first|, jonka on oltava olemassa. Ja kenttä \mintinline{javascript}|rest|, jossa säilytetään listan loput alkiot. Kentän lista on taas tavallinen \mintinline{javascript}|Array|, ja se voi, ja saa olla, taas tyhjä (Esimerkkikoodi \ref{code:ts_non_empty_quiz}).
