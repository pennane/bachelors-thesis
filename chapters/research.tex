...
On tärkeää, että abstrahoinnin taso pysyy hallittuna, eikä yhdistetty funktio tuo mukanaan lisämonimutkaisuutta. Myös tässä on vahvana ajatus siitä, että kannattaa käyttää kielen omia ominaisuuksia turhan kirjastokoodin sijasta. Tai jos kirjastokoodiakäyttää, on sen oltava johdonmukaista. Koodikannoissa, joissa työskentelevät monet ohjelmoijat, teippiratkaisut ovat erittäin haitallisia.
